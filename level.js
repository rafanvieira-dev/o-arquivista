// A linha base. Tudo nasce perfeitamente daqui!
const FLOOR_Y = 500;
...
const levelData = {
    platforms: [
        ...
        // Armários grudados no chão (Y = FLOOR_Y - altura)
    ...
    items: [
        // Itens colados ao topo dos armários (Y = Y_do_armário - 40 de altura do item)
